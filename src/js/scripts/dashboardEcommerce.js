...
function revenueSumChart() {
  ...
  const chart = new ApexCharts(document.getElementById('revenueSumChart'), options)
  chart.render()
}
...
function salesByCategoryChart() {
  var options = {
    ...
    colors: [theme.colors.indigo[400], theme.colors.green[400], theme.colors.yellow[300], theme.colors.red[400]],
    chart: {
      type: 'donut',
      width: '100%',
      height: '100%',
  ...
  var chart = new ApexCharts(document.getElementById('salesByCategoryChart'), options);
  chart.render();
}
