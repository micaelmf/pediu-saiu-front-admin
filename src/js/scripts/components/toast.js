...
// Simple Toast
document
  .querySelector('#simpleToastButton')
  .addEventListener('click', () => {
    Toast('Simple toast!').showToast()
  })

document
  .querySelector('#simpleToastCloseButton')
  .addEventListener('click', () => {
...
// Permanent Toast
document
  .querySelector('#permanentToastButton')
  .addEventListener('click', () => {
...
// Toast Destination
document
  .querySelector('#toastDestinationButton')
  .addEventListener('click', () => {
...
// Success Toast
document
  .querySelector('#successToastTextButton')
  .addEventListener('click', () => {
    Toast.success('Hooray!').showToast()
  })

document
  .querySelector('#successToastHTMLButton')
  .addEventListener('click', () => {
    Toast.success(`
...
// Success Toast
document
  .querySelector('#errorToastTextButton')
  .addEventListener('click', () => {
    Toast.error('Something went wrong').showToast()
  })

document
  .querySelector('#errorToastHTMLButton')
  .addEventListener('click', () => {
    Toast.error(`
      <div class="flex flex-col gap-1">
        <strong>Error</strong>
...
// Warning Toast
document
  .querySelector('#warningToastTextButton')
  .addEventListener('click', () => {
    Toast.warn('Your data will be lost').showToast()
  })

document
  .querySelector('#warningToastHTMLButton')
  .addEventListener('click', () => {
    Toast.warn(`
      <div class="flex flex-col gap-1">
