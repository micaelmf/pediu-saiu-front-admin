    ...
    const code = `
      <ul class="tabs ${exampleForm.variant.value}" role="tablist">
        <li role="presentation">
          <a href="#" class="tab tab--active">${withIcon ? `
            <i data-icon="feather__user" class="w-5 h-5"></i>` : ``}
            Profile
          </a>
        </li>
        <li role="presentation">
          <a href="#" class="tab">${withIcon ? `
  ...
  const updateExampleCodeContent = () => {
    ...
    const code = `
      <ul id="interactiveTabs" class="tabs ${exampleForm.variant.value}" data-tabs-toggle role="tablist">
        <li role="presentation">
          <button class="tab" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">${withIcon ? `
            <i data-icon="feather__user" class="w-5 h-5"></i>` : ``}
            Profile
          </button>
        </li>
        <li role="presentation">
          <button class="tab" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">${withIcon ? `
            <i data-icon="feather__barChart2" class="w-5 h-5"></i>` : ``}
            Dashboard
          </button>
        </li>
        <li role="presentation">
          <button class="tab" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">${withIcon ? `
            <i data-icon="feather__settings" class="w-5 h-5"></i>` : ``}
            Settings
          </button>
        </li>
        <li role="presentation">
          <button class="tab" id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">${withIcon ? `
            <i data-icon="feather__users" class="w-5 h-5"></i>` : ``}
            Contacts
          </button>
        </li>
